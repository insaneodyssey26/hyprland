...
-- Resizing and Moving (Fallback to hyprctl dispatch to ensure 100% stability)
hl.bind("SUPER + CTRL + right", hl.dsp.exec_cmd("hyprctl dispatch resizeactive 20 0"), { repeating = true })
hl.bind("SUPER + CTRL + left",  hl.dsp.exec_cmd("hyprctl dispatch resizeactive -20 0"), { repeating = true })
hl.bind("SUPER + CTRL + up",    hl.dsp.exec_cmd("hyprctl dispatch resizeactive 0 -20"), { repeating = true })
hl.bind("SUPER + CTRL + down",  hl.dsp.exec_cmd("hyprctl dispatch resizeactive 0 20"), { repeating = true })

hl.bind("SUPER + ALT + right", hl.dsp.exec_cmd("hyprctl dispatch moveactive 20 0"), { repeating = true })
hl.bind("SUPER + ALT + left",  hl.dsp.exec_cmd("hyprctl dispatch moveactive -20 0"), { repeating = true })
hl.bind("SUPER + ALT + up",    hl.dsp.exec_cmd("hyprctl dispatch moveactive 0 -20"), { repeating = true })
hl.bind("SUPER + ALT + down",  hl.dsp.exec_cmd("hyprctl dispatch moveactive 0 20"), { repeating = true })
